...
from darts.models.forecasting.prophet_model import Prophet   # need pip install prophet
from darts.models.forecasting.arima import ARIMA   # add enforce_stationarity=False at line165 in ARIMA
from darts.models.forecasting.theta import Theta   # choose SeasonalityMode, default multiplicative in Theta
...
def generate_forecasts(
    ...
    **kwargs
    ...
    # if log:  # if negitive values, do not take log
    ...
    if model_name == "prophet":
        ...
        model = TransformerModel(12,ahead,n_epochs=100)
