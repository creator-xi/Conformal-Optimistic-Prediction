...
if __name__ == "__main__":
    ...
    method_title_map = {
        ...
        'ECI': 'ECI',
        'ECI_cutoff': 'ECI-cutoff',
        'ECI_integral': 'ECI-integral',
        'LQT': 'LQT',
        'COP': 'COP'
    }
    ...
    for model_name in model_names:
        ...
        plt.subplots_adjust(left=0.08, bottom=0.1, right=0.95, wspace=0.2, hspace=0.1)  # 4 methods
        # plt.subplots_adjust(left=0.05, bottom=0.08, right=0.95, wspace=0.2, hspace=0.1)  # 7 methods
        ...
        # plt.subplots_adjust(left=0.1, bottom=0.1, right=0.95, wspace=0.2, hspace=0.1)  # 5 methods
        plt.subplots_adjust(left=0.05, bottom=0.1, right=0.95, wspace=0.2, hspace=0.15) # 7 methods
        ...
        if real_data:
            ...
            plt.tight_layout(pad=0.05)
            # plt.subplots_adjust(left=0.07, bottom=0.07, right=0.95, wspace=0.2)  # 5 methods
            plt.subplots_adjust(left=0.06, bottom=0.08, right=0.95, wspace=0.2, hspace=0.1) # 7 methods
        ...
        if real_data:
            ...
            plt.tight_layout(pad=0.05)
            # plt.subplots_adjust(left=0.07, bottom=0.07, right=0.95, wspace=0.2)
            # plt.subplots_adjust(left=0.08, bottom=0.08, right=0.95, wspace=0.2, hspace=0.1)  # 5 methods
            plt.subplots_adjust(left=0.05, bottom=0.08, right=0.95, wspace=0.2, hspace=0.1) # 7 methods
